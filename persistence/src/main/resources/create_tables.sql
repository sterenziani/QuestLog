...
ALTER TABLE releases ADD FOREIGN KEY(game) REFERENCES games ON DELETE CASCADE;
ALTER TABLE releases ADD FOREIGN KEY(region) REFERENCES regions ON DELETE CASCADE;
...
ALTER TABLE scores ADD FOREIGN KEY(game) REFERENCES games ON DELETE CASCADE;
ALTER TABLE scores ADD FOREIGN KEY(user_id) REFERENCES users ON DELETE CASCADE;
...
ALTER TABLE runs ADD FOREIGN KEY(game) REFERENCES games ON DELETE CASCADE;
ALTER TABLE runs ADD FOREIGN KEY(platform) REFERENCES platforms ON DELETE CASCADE;
ALTER TABLE runs ADD FOREIGN KEY(user_id) REFERENCES users ON DELETE CASCADE;
ALTER TABLE runs ADD FOREIGN KEY(playstyle) REFERENCES playstyles ON DELETE CASCADE;
...
ALTER TABLE classifications ADD FOREIGN KEY(game) REFERENCES games ON DELETE CASCADE;
ALTER TABLE classifications ADD FOREIGN KEY(genre) REFERENCES genres ON DELETE CASCADE;
...
ALTER TABLE backlogs ADD FOREIGN KEY(game) REFERENCES games ON DELETE CASCADE;
ALTER TABLE backlogs ADD FOREIGN KEY(user_id) REFERENCES users ON DELETE CASCADE;
...
ALTER TABLE development ADD FOREIGN KEY(game) REFERENCES games ON DELETE CASCADE;
ALTER TABLE development ADD FOREIGN KEY(developer) REFERENCES developers ON DELETE CASCADE;
...
ALTER TABLE publishing ADD FOREIGN KEY(game) REFERENCES games ON DELETE CASCADE;
