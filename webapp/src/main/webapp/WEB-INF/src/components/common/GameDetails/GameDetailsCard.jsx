        ...
        return (
            <Card className="m-3 d-flex bg-transparent" style={{width: '18rem', border: '0'}}>
              ...
              <div className="d-flex flex-column flex-grow-1 text-white">
                ...
                { trailerAvailable? [<iframe width="100%" height="100%" src={'https://www.youtube.com/embed/' +this.props.game.trailer} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen" allowFullScreen title="trailer"></iframe>] : []}
              </div>
            </Card>
        )
    }
