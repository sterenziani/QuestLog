...
<form class="d-flex flex-grow-1 flex-lg-row flex-column" id="form" action="<c:url value="/search"/>">
    ...
    <input type="hidden" value="1" name="page"/>
 	<c:if test="${!gameSearchResults}">
	    <select class="h-100 form-control bg-dark text-white border-dark mr-0 mr-lg-2" name="searchType" id="searchType" onchange="searchTypeFunction()">
