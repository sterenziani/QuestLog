...
<link rel="apple-touch-icon" sizes="180x180" href="<c:url value="/images/static/favicon/apple-touch-icon.png"/>">
<link rel="icon" type="image/png" sizes="32x32" href="<c:url value="/images/static/favicon/favicon-32x32.png"/>">
<link rel="icon" type="image/png" sizes="16x16" href="<c:url value="/images/static/favicon/favicon-16x16.png"/>">
<link rel="manifest" href="<c:url value="/images/static/favicon/site.webmanifest"/>">