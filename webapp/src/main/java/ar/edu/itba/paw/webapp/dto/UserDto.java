...
public class UserDto
{
	...
	@NotNull
	private String locale; // Debería venir en forma "en-us" en vez de "en_US"
	...
	public URI getBacklog_url() {
		return backlog_url;
	}

	public void setBacklog_url(URI backlog_url) {
		this.backlog_url = backlog_url;
	}
